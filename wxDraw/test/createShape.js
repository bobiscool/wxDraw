...
let polygon = new Shape('polygon', { x: 200, y: 200, r:40,sides:9, fillStyle: "#FC354C", rotate: Math.PI / 4, needGra: true, lg: [[0, '#00A0B0'], [0.2, '#6A4A3C'], [0.4, '#CC333F'], [0.6, '#EB6841'], [1, '#EDC951']] }, 'mix', true)
let text = new Shape('text', { x: 200, y: 200, text:"我是测试文字", fillStyle: "#E6781E", rotate: Math.PI / 3 }, 'fill', true)
let line = new Shape('line', { points: [[70, 85], [40, 20], [24, 46], [2, 4], [14, 6], [4, 46]], fillStyle: "#2FB8AC", rotate: 0, needShadow: true }, 'stroke', true)
