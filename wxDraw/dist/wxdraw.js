...
var shapeBase = function () {
  ...
  createClass(shapeBase, [{
    ...
    key: 'restoreOption',
    value: function restoreOption(oldOption) {
      // console.log(oldOption);
      this.Option = util.extend(oldOption, this.Option);
      this.UnOption = util.extend(oldOption, this.UnOption);
      // console.log('更新属性',this.Option);
    ...
    key: 'mixDraw',
    value: function mixDraw(context) {
      if (this._type == "line") {
        this.stroke(context); //这里先这样写吧
        return false;
      }
    ...
    key: 'turnColorLock',
    value: function turnColorLock(onOff) {
      if (onOff) {
        this._colorLock = true;
      } else {
        this._colorLock = false;
    ...
    key: 'getGradientOption',
    value: function getGradientOption(type) {
      return {
        circle: type == "circle" ? {
          lg: [this.Option.x - this.Option.r, 0, this.Option.x + this.Option.r, 0],
          cg: [this.Option.x, this.Option.y, this.Option.r]
    ...
    key: '_drawHelperPoints',
    value: function _drawHelperPoints(context) {
      // 绘制辅助点
      context.save();
      context.setFillStyle("#F34739");
      context.beginPath();
    ...
    key: 'closeRotateOrigin',
    value: function closeRotateOrigin() {
      this._canRotateOrigin = false; // 限制 rotateOrigin
    }
  }, {
    key: '_pnpolyTest',
 ...
 * 
 */
var Circle = function (_shapeBase) {
    inherits(Circle, _shapeBase);
...
Shape.prototype = {
     ...
     * 准备用于添加插件
     */
    addShape: function addShape(name, shapeClass) {
