...
-  linedash
-  贝塞尔曲线
-  曲线的点击。。可以用小方块点击法、、、、卧槽 牛逼 我 居然想出这么恶心的方法「小方块就是隶属于曲线的每一个像素块每一个像素块都有自己的位置还有,w,h只要小方块被点击了 那就是父集被点击了。。。卧槽我是天才。。。。。不过如果每一个这么来绘制的话。。 曲线会长得很丑 特别是转弯的地方小方块还是长那样 而且不能 lineDash」
