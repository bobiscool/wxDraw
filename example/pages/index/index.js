...
Page({
  ...
  onLoad: function () {
    ...
    */
    ...
    let circle = new Shape('circle', { x: 100, y: 100, r: 40, sA: 0, fillStyle: "#C0D860", strokeStyle: "#CC333F", rotate: 20, lineWidth: 0,needGra: 'line', gra: [[0, '#00A0B0'], [0.2, '#6A4A3C'], [0.4, '#CC333F'], [0.6, '#EB6841'], [1, '#EDC951']]}, 'mix', true)
    console.log(circle);
